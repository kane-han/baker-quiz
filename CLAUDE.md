...
## 현재 기능
- 제빵기능사 모의고사 20개 시험 (원본 1회 + 2007~2011년 19회차, 각 60문제)
- 제과기능사 모의고사 20개 시험 (원본 1회 + 2007~2011년 19회차, 각 60문제)
- 총 2,400문제 (40개 시험 × 60문제), 전체 해설 포함
- 정답/해설 5회 검증 완료 (~650건 정답 수정 + 437건 해설 재작성, 원본 이미지 + PDF 교사용 38개 대조)
- 카테고리(제빵/제과) → 회차 선택 → 시험 UI 흐름
- **챕터별 학습**: 5개 과목별 랜덤 20문제 출제
  - 재료과학(875), 제조이론(822), 식품위생학(344), 영양학(315), 경영관리(44)
...
```
baker-quiz/
├── index.html          # 메인 앱 (HTML/CSS/JS 통합, 2400문제+해설)
